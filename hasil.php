...
<h3 class = "mt-4 border-bottom text-center">Form Perhitungan</h3>
<form class="col-md-4 mx-auto mt-4" action="hasil.php" method="POST">
...
echo "<br>";
echo 'Luas Persegi Panjang : '. $LuasPersegi->luas();
echo "<br>";
echo 'Keliling Persegi Panjang : '. $LuasPersegi->keliling();
?>
</body>
</html>